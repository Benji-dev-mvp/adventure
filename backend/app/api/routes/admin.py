...
from app.models.user import User, UserRole, UserCreate, UserUpdate, Permission
from app.models.audit import AuditLog, AuditLogFilter, AuditAction
...
async def audit_log_stats(
    ...
    return {
        ...
        "success_rate": round((total_actions - failed_actions) / total_actions * 100, 2) if total_actions > 0 else 100,
