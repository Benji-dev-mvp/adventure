...
async def record_consent(
    consent_type: str, granted: bool, current_user: User = Depends(get_current_user)
):
    """Record user consent for GDPR compliance."""
    record = compliance_service.generate_consent_record(current_user.id, consent_type, granted)
    return record
