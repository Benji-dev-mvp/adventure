...
def get_campaign_sequence(
    ...
    return {
        "sequence": [
            {"step": 1, "channel": "email", "delay_days": 0, "subject": "Initial outreach"},
            {"step": 2, "channel": "linkedin", "delay_days": 2, "message": "Connection request"},
            {"step": 3, "channel": "email", "delay_days": 5, "subject": "Follow-up"},
            {"step": 4, "channel": "phone", "delay_days": 7, "script": "Discovery call"}
        ],
        "routing_rules": {
...
def get_channel_performance(
    ...
    return {
        "channels": [
            {"name": "Email", "sent": 12847, "opened": 11432, "replied": 892, "booked": 67, "open_rate": 89, "reply_rate": 7},
            {"name": "LinkedIn", "sent": 8392, "accepted": 6142, "replied": 523, "booked": 45, "accept_rate": 73, "reply_rate": 6},
            {"name": "SMS", "sent": 2104, "delivered": 2089, "replied": 189, "booked": 12, "delivery_rate": 99, "reply_rate": 9},
            {"name": "Phone", "attempted": 1523, "connected": 847, "conversations": 412, "booked": 89, "connect_rate": 56, "conversion_rate": 21},
            {"name": "WhatsApp", "sent": 892, "delivered": 876, "replied": 123, "booked": 8, "delivery_rate": 98, "reply_rate": 14}
        ]
    }
...
def get_filter_options(current_user: User = Depends(get_current_user)):
    ...
    return {
        ...
        "intent_signals": ["job_posting", "funding_event", "technology_install", "web_research"]
    }
...
def get_enrichment_job(
    ...
    return {
        ...
        "data_points": ["email", "phone", "job_title", "company", "linkedin", "tech_stack"]
    }
...
def list_enrichment_providers(current_user: User = Depends(get_current_user)):
    ...
    return {
        "providers": [
            {"name": "ZoomInfo", "status": "active", "coverage": 95, "latency_ms": 120, "cost_tier": 3},
            {"name": "Clearbit", "status": "active", "coverage": 88, "latency_ms": 80, "cost_tier": 2},
            {"name": "Apollo.io", "status": "active", "coverage": 92, "latency_ms": 150, "cost_tier": 2},
            {"name": "Hunter.io", "status": "active", "coverage": 78, "latency_ms": 60, "cost_tier": 1},
            {"name": "LinkedIn", "status": "active", "coverage": 98, "latency_ms": 200, "cost_tier": 3},
            {"name": "Crunchbase", "status": "active", "coverage": 85, "latency_ms": 100, "cost_tier": 2}
        ]
    }
