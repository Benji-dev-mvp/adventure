...
class APIVersionManager:
    ...
    VERSIONS = {
        ...
        "v2": {"status": "current", "sunset_date": None, "message": None},
        "v3": {
            "status": "beta",
            "sunset_date": None,
    ...
    def get_version_info(version: str) -> Dict[str, Any]:
        ...
        return APIVersionManager.VERSIONS.get(
            version, {"status": "unknown", "message": "Unknown API version"}
        )
...
class RateLimiter:
    ...
    def check_rate_limit(
        user_id: int, tier: str, current_usage: Dict[str, int]
