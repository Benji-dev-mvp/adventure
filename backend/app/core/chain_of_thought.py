...
class ChainOfThoughtReasoning:
    ...
    async def reason_and_act(
        self, goal: str, context: Dict[str, Any], available_actions: List[str]
    ) -> Dict[str, Any]:
        """
...
"""
        ...
        while step_number < self.max_steps:
            ...
            observation = await self._execute_action(
                reasoning.get("action"), reasoning.get("action_params", {})
            )
            ...
            # Add to conversation
            conversation_history.append({"role": "assistant", "content": json.dumps(reasoning)})
...
class ExplainableAIBDR:
    ...
    async def research_and_engage(self, lead_data: Dict[str, Any]) -> Dict[str, Any]:
        """
...
async def create_explainable_outreach(
    lead_data: Dict[str, Any], openai_api_key: str
) -> Dict[str, Any]:
    """
