...
"""
        ...
        response = await self.client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are an expert at diagnosing and fixing software errors.",
                },
    ...
    def get_recovery_stats(self) -> Dict[str, Any]:
        ...
        for category in ErrorCategory:
            ...
            if category_results:
                success_rate = sum(1 for r in category_results if r.final_success) / len(
                    category_results
                )
                by_category[category.value] = {
                    ...
                    "avg_attempts": round(
                        sum(r.total_attempts for r in category_results) / len(category_results),
                        1,
                    ),
                }
