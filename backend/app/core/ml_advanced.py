...
class NextBestAction:
    ...
    ACTION_TYPES = ["email", "call", "linkedin", "meeting", "demo", "proposal", "follow_up"]
...
class SentimentAnalysis:
    ...
    def analyze(text: str) -> Dict[str, Any]:
        ...
        positive_keywords = ["great", "interested", "excited", "love", "perfect", "yes", "definitely"]
        negative_keywords = ["not interested", "no thanks", "busy", "unsubscribe", "stop", "never"]
...
class LookalikeModeling:
    ...
    def find_lookalikes(
        ...
        for candidate in candidate_pool:
            similarity_score = LookalikeModeling._calculate_similarity(
                source_profile,
                candidate
            )
