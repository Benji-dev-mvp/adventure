...
class PerformanceMonitor:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'p95_response_time': sorted_times[int(count * 0.95)] if count > 20 else sorted_times[-1],
            'p99_response_time': sorted_times[int(count * 0.99)] if count > 100 else sorted_times[-1],
