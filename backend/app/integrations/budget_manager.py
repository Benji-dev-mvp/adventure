...
class BudgetManager:
    ...
    def __init__(self, global_config: Dict[str, Any]):
        ...
        self.default_daily_token_limit_per_user = global_config.get("daily_token_limit_per_user", 500000)
        self.default_daily_cost_limit_per_user = global_config.get("daily_cost_limit_per_user", 50.0)
        self.default_daily_token_limit_per_org = global_config.get("daily_token_limit_per_org", 5000000)
    ...
    async def get_remaining_budget(
        ...
        return {
            "user": {
                ...
                "tokens_remaining": max(0, self.default_daily_token_limit_per_user - user_usage["tokens"]),
                "tokens_limit": self.default_daily_token_limit_per_user,
                "cost_used": user_usage["cost"],
                "cost_remaining": max(0, self.default_daily_cost_limit_per_user - user_usage["cost"]),
                "cost_limit": self.default_daily_cost_limit_per_user,
            },
            "org": {
                "tokens_used": org_usage["tokens"],
                "tokens_remaining": max(0, self.default_daily_token_limit_per_org - org_usage["tokens"]),
