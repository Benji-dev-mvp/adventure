...
class OpenAIService:
    ...
    def personalize_template(self, template: str, lead_data: Dict[str, Any]) -> str:
        """
...
Return ONLY the personalized email, no explanations."""
    ...
    def _build_email_prompt(
        self, persona: str, pain_point: str, tone: str, context: Optional[str] = None
    ) -> str:
...
- urgent: emphasize time-sensitivity"""
    ...
    def _parse_email_response(
        self, content: str, tokens: int, model: str
    ) -> EmailGenerationResponse:
    ...
    def _mock_email(self, persona: str, pain_point: str, tone: str) -> EmailGenerationResponse:
