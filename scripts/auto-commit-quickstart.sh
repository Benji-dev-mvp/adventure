...
echo "   ./scripts/auto-commit.sh \"Your custom message\""
echo ""
echo "2. Watch mode (continuous):"
echo "   ./scripts/watch-and-commit.sh"
echo "   ./scripts/watch-and-commit.sh ./src 120  # Watch src folder every 2 min"
echo ""
...
echo ""
echo "📚 Full documentation: docs/ops/AUTO_COMMIT_GUIDE.md"
echo ""
