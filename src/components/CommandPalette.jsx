...
const navigationItems = [
  { id: 'dashboard', label: 'Dashboard', path: '/dashboard', icon: LayoutDashboard, keywords: ['home', 'overview'] },
  { id: 'leads', label: 'Leads', path: '/leads', icon: Users, keywords: ['contacts', 'prospects'] },
  { id: 'campaigns', label: 'Campaigns', path: '/campaigns', icon: Target, keywords: ['outreach', 'email'] },
  { id: 'analytics', label: 'Analytics', path: '/analytics', icon: BarChart3, keywords: ['reports', 'metrics', 'stats'] },
  { id: 'templates', label: 'Templates', path: '/templates', icon: FileText, keywords: ['email templates'] },
  { id: 'integrations', label: 'Integrations', path: '/integrations', icon: Plug, keywords: ['connect', 'crm', 'api'] },
  { id: 'settings', label: 'Settings', path: '/settings', icon: Settings, keywords: ['preferences', 'config'] },
  { id: 'help', label: 'Help Center', path: '/help', icon: HelpCircle, keywords: ['support', 'docs'] },
];

// Advanced features
const advancedItems = [
  { id: 'ai-assistant', label: 'AI Assistant', path: '/ai-assistant', icon: Brain, keywords: ['ava', 'ai', 'chat'] },
  { id: 'ai-lead', label: 'AI Lead Intelligence', path: '/ai-lead-intelligence', icon: Sparkles, keywords: ['scoring', 'enrichment'] },
  { id: 'workflow', label: 'Workflow Orchestrator', path: '/workflow-orchestrator', icon: Zap, keywords: ['automation', 'flows'] },
  { id: 'visual-builder', label: 'Visual Campaign Builder', path: '/campaigns/visual', icon: Target, keywords: ['drag drop', 'n8n'] },
  { id: 'executive', label: 'Executive Dashboard', path: '/executive-dashboard', icon: TrendingUp, keywords: ['ceo', 'overview'] },
  { id: 'calendar', label: 'Calendar Scheduler', path: '/calendar-scheduler', icon: Calendar, keywords: ['meetings', 'schedule'] },
  { id: 'compliance', label: 'Compliance Center', path: '/compliance-center', icon: Shield, keywords: ['gdpr', 'security'] },
];

// Quick actions
const actionItems = [
  { id: 'new-campaign', label: 'Create New Campaign', action: 'newCampaign', icon: Plus, keywords: ['add'] },
  { id: 'new-lead', label: 'Add New Lead', action: 'newLead', icon: Plus, keywords: ['add contact'] },
  { id: 'new-template', label: 'Create Template', action: 'newTemplate', icon: Mail, keywords: ['add email'] },
  { id: 'search-leads', label: 'Search Leads...', action: 'searchLeads', icon: Search, keywords: ['find'] },
];
