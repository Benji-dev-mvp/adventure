    ...
    <div className="space-y-4">
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <div className="font-semibold text-gray-900 dark:text-white">{segment.label}</div>
                </div>
              </div>

              <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">{segment.description}</p>
      ...
      <div className="mt-4 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 p-3">
        <p className="text-sm text-amber-800 dark:text-amber-200">
          <strong>Demo Mode:</strong> You're viewing a demo organization. Switching segments will
          change visible features and demo data throughout the app.
        </p>
      </div>
    </div>
  );
