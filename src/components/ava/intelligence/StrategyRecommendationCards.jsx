...
import {
  ...
  ChevronRight, ThumbsUp, ThumbsDown, RefreshCw, Brain
} from 'lucide-react';
          ...
          {insight.metric && (
            <div className="flex items-center gap-1 text-xs">
              ...
              <span className={insight.metricTrend >= 0 ? 'text-green-600' : 'text-red-600'}>
                {insight.metricTrend >= 0 ? '+' : ''}{insight.metricTrend}% {insight.metric}
              </span>
            </div>
          )}
        </div>
      ...
      {expanded && (
        <div className="px-4 pb-4 space-y-4 animate-fadeIn">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-200 dark:border-gray-700">
            <span className="text-xs text-gray-500 dark:text-gray-400">Was this insight helpful?</span>
            <div className="flex items-center gap-2">
              <button
...
// Main Component
export const StrategyRecommendationCards = ({ playbooks = [], runs = [], onApplyRecommendation }) => {
    ...
    return [
      {
        ...
        summary: 'Enterprise segment shows significantly higher response rates on LinkedIn compared to email. Consider rebalancing channel mix.',
        analysis: 'Analysis of the last 30 days shows that LinkedIn outreach to enterprise accounts has a 34% response rate compared to 23% for email. The key differentiator appears to be the personalization depth possible on LinkedIn, where leads can verify sender credibility instantly.',
        impact: 85,
        effort: '2-3 hours',
      ...
      },
      {
        ...
        summary: 'Response rates for startup-focused playbooks have dropped 23% week-over-week. Immediate attention required.',
        analysis: 'The startup segment is showing signs of message fatigue. Open rates remain stable (42%) but click-through and response rates are declining. This pattern typically indicates that the initial hook is working but the value proposition isn\'t resonating.',
        impact: 72,
        effort: '4-6 hours',
        metric: 'response rate',
        metricTrend: -23,
      ...
      },
      {
        ...
        summary: 'AI analysis identifies high-intent signals in tech mid-market that current playbooks aren\'t targeting.',
        analysis: 'Our data enrichment shows 847 mid-market tech companies with recent hiring activity in sales/marketing roles—a strong buying signal. Current playbooks only reach 12% of this segment. Creating a dedicated playbook could generate an estimated 34 additional meetings per month.',
        impact: 68,
        effort: '1 week',
        metric: 'meetings',
        metricTrend: 34,
      ...
      },
      {
        ...
        summary: 'Timing analysis reveals optimal send windows that could double response rates across all playbooks.',
        analysis: 'Deep analysis of 12,847 emails over 90 days reveals strong patterns in response behavior. Tuesday at 10 AM local time consistently outperforms all other slots by 2x. Friday afternoons show 67% lower engagement. Implementing smart send-time optimization could improve overall results by 35%.',
        impact: 55,
        effort: '30 minutes',
        metric: 'reply rate',
        metricTrend: 112,
      ...
      },
      {
        ...
        summary: 'AI predicts current active sequences will generate 28 meetings over the next 14 days based on historical patterns.',
        analysis: 'Based on current engagement patterns and historical conversion data, we predict 28 meetings (±5) will be booked from sequences currently in motion. This is 15% above the monthly target. Key drivers: strong enterprise LinkedIn engagement and improved objection handling responses.',
        impact: 78,
        effort: 'Monitor',
        metric: 'meetings',
        metricTrend: 15,
