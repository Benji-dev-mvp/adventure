...
export const LiveActivityFeed = () => {
  ...
  const activityTypes = [
    { type: 'email_opened', icon: Mail, color: 'text-blue-500', bg: 'bg-blue-50 dark:bg-blue-900/20' },
    { type: 'link_clicked', icon: MousePointerClick, color: 'text-purple-500', bg: 'bg-purple-50 dark:bg-purple-900/20' },
    { type: 'meeting_booked', icon: Calendar, color: 'text-green-500', bg: 'bg-green-50 dark:bg-green-900/20' },
    { type: 'lead_added', icon: UserPlus, color: 'text-indigo-500', bg: 'bg-indigo-50 dark:bg-indigo-900/20' },
    { type: 'reply_received', icon: TrendingUp, color: 'text-orange-500', bg: 'bg-orange-50 dark:bg-orange-900/20' },
  ];

  useEffect(() => {
    const generateActivity = () => {
      const names = ['Sarah Chen', 'Michael Roberts', 'Emily Davis', 'James Wilson', 'Lisa Anderson', 'David Martinez'];
      const companies = ['TechCorp', 'CloudScale', 'DataFlow', 'InnovateLabs', 'NexGen Systems', 'Quantum Dynamics'];
