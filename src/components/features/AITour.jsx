...
const AITour = () => {
  ...
  return (
    <section
      id="ai-tour"
      className="relative overflow-hidden py-20 px-6 bg-gradient-to-br from-slate-900 via-slate-950 to-purple-950 text-white"
    >
      <div
            ...
            <div className="space-y-4">
              {tourScenes.map(scene => {
                ...
                return (
                  <div
                    key={scene.title}
                    className="rounded-2xl futuristic-card border border-white/20 p-4 hover-lift"
                  >
