...
const PlatformArchitecture = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setLiveMetrics(prev => ({
        leadsProcessed: Math.min(
          prev.leadsProcessed + Math.floor(Math.random() * 50 + 20),
          1200000
        ),
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setParticles(prev =>
        prev.map(p => ({ ...p, progress: p.progress + 2 })).filter(p => p.progress < 100)
      );
    }, 50);
    return () => clearInterval(interval);
  }, []);
  ...
  const nodes = {
    database: {
      ...
      description:
        'Real-time access to enriched B2B data with intent signals, technographics, and firmographics',
    ...
    enrichment: {
      ...
      description:
        'Enriches leads with company data, social profiles, and verified contact information',
    ...
    ai: {
      ...
      description:
        'Advanced AI personalization engine that analyzes leads and contextual, multi-tone outreach',
    ...
    channels: {
      ...
      description:
        'Orchestrated outreach across all channels with smart timing and deliverability optimization',
    ...
    analytics: {
      ...
      description:
        'Executive-ready dashboards with pipeline health, conversion funnels, and ROI tracking',
              ...
              {flowStages.map((stage, idx) => (
                <React.Fragment key={idx}>
                  ...
                  >
                    ...
                    {/* Stage Number Badge */}
                    <div
                      className={`absolute -top-2 -left-2 w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 ${
                        stage.active
                    ...
                    <div className="flex-shrink-0 flex flex-col items-center justify-center gap-1">
                      ...
                      {stage.active && (
                        <div className="flex gap-1">
                          <div
                            className="w-1 h-1 rounded-full bg-blue-400 animate-ping"
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {isNodeActive && (
                      <div
                        className={`absolute inset-0 bg-gradient-to-br ${node.color} opacity-5 animate-pulse`}
                      />
                    )}
                    ...
                    <CardContent className="p-3 relative z-10">
                      <div className="flex items-start gap-2 mb-2">
                        <div
                          className={`w-9 h-9 rounded-lg bg-gradient-to-br ${node.color} flex items-center justify-center shadow-lg flex-shrink-0 ${
                        ...
                        <div className="flex items-center gap-0.5 flex-shrink-0">
                          ...
                          <span className="text-[7px] text-green-600 dark:text-green-400 font-semibold">
                            LIVE
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-0.5 mb-2">
                        {node.metrics.slice(0, 2).map((metric, idx) => (
                          <div key={idx} className="flex items-center gap-1">
                            <div
                              className={`w-0.5 h-0.5 rounded-full bg-gradient-to-r ${node.color}`}
                            />
                            <span className="text-[8px] text-slate-600 dark:text-slate-400 leading-tight">
                              {metric}
                            </span>
                          </div>
                        ))}
                      ...
                      {node.subChannels && !isNodeActive && (
                        <div className="grid grid-cols-2 gap-1">
                          {node.subChannels.map((channel, idx) => (
                            <div
                              key={idx}
                              className="flex items-center gap-1 p-1 rounded bg-slate-50 dark:bg-slate-700/50"
                            >
                              <channel.icon
                                className={`w-2.5 h-2.5 ${channel.color} flex-shrink-0`}
                              />
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 border-purple-200 dark:border-purple-800">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300">
                GPT-4 drives personalization at scale with human-in-the-loop controls and approval
                workflows
              </p>
            </CardContent>
          </Card>
