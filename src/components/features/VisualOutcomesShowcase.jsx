  ...
  const outcomes = [
    {
      ...
      quote: "Ava handles what used to take 15 SDRs. Our team now focuses on closing deals, not writing emails.",
    ...
    },
    {
      ...
      quote: "The AI doesn't just send emails—it understands buyer intent and adjusts messaging in real-time.",
    ...
    },
    {
      ...
      results: [
        ...
        { label: "Compliance Violations", before: "14/quarter", after: "0/quarter", increase: "-100%" },
      ...
      quote: "Finally, an outbound tool our security team approved in 3 days instead of blocking for months.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
            From struggling with scale to 3x pipeline growth—see the quantified outcomes that convinced their boards
          </p>
        </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                ...
                <p className="text-blue-100">{currentOutcome.industry} • {currentOutcome.timeline} implementation</p>
              </div>
              <div className="flex items-center gap-3">
                ...
                {outcomes.map((_, idx) => (
                  <button
                    key={idx}
                    onClick={() => { setActiveOutcome(idx); setIsPlaying(false); }}
                  ...
                  >
                    ...
                    <div className="space-y-2 mb-3">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-semibold text-red-600 dark:text-red-400">{result.before}</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-slate-600 dark:text-slate-400">After:</span>
                        <span className="text-sm font-semibold text-green-600 dark:text-green-400">{result.after}</span>
                      </div>
                    </div>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-xl p-6 border-2 border-purple-200 dark:border-purple-800">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center text-white font-bold text-lg flex-shrink-0">
                  {currentOutcome.author.split(' ').map(n => n[0]).join('')}
                </div>
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    <div>
                      <div className="font-semibold text-slate-900 dark:text-white">{currentOutcome.author}</div>
                      <div className="text-sm text-slate-600 dark:text-slate-400">{currentOutcome.company}</div>
                    </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="text-center p-6 bg-white dark:bg-slate-800 rounded-xl border-2 border-slate-200 dark:border-slate-700">
            ...
            <div className="text-sm text-slate-600 dark:text-slate-400">Pipeline Generated (30d)</div>
          </div>
          <div className="text-center p-6 bg-white dark:bg-slate-800 rounded-xl border-2 border-slate-200 dark:border-slate-700">
            <div className="text-3xl font-bold text-orange-600 dark:text-orange-400 mb-1">98.4%</div>
