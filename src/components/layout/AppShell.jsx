...
import { Menu, X, ChevronDown, Sparkles, Play, Workflow, Server, Shield, Users, CreditCard, LogIn, MessageSquare, Rocket, Building2, Building } from 'lucide-react';
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <GlassCard variant="default" className="border border-white/10 shadow-2xl overflow-hidden">
            <div className="p-2">
              {SOLUTIONS.map((solution, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`w-10 h-10 rounded-lg bg-gradient-to-br ${solution.color} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform`}>
            ...
            >
              ...
              <div className="pt-4 border-t border-white/10 space-y-2">
                <Link to="/dashboard" onClick={() => setMobileMenuOpen(false)}>
                  <GlowButtonOutline variant="ghost" size="md" className="w-full justify-center gap-2">
                    <LogIn size={16} />
                    Login
                  </GlowButtonOutline>
                </Link>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid md:grid-cols-5 gap-12 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                ...
                Automate 80% of your outbound workflow with Ava, your AI BDR.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                ...
                <li><Link to="/flow" className="hover:text-cyan-400 transition-colors">How It Works</Link></li>
                <li><Link to="/ai-tour" className="hover:text-cyan-400 transition-colors">AI Tour</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                <li><Link to="/solutions/startups" className="hover:text-cyan-400 transition-colors">Startups</Link></li>
                <li><Link to="/solutions/midmarket" className="hover:text-cyan-400 transition-colors">Midmarket</Link></li>
                <li><Link to="/solutions/enterprise" className="hover:text-cyan-400 transition-colors">Enterprise</Link></li>
                <li><Link to="/customers" className="hover:text-cyan-400 transition-colors">Customer Stories</Link></li>
              </ul>
            </div>
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm text-gray-400">
              <Link to="/security" className="hover:text-cyan-400 transition-colors">Status</Link>
