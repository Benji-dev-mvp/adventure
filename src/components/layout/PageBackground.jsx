...
const PageBackground = ({ children }) => {
  ...
  return (
    <div
      className={`min-h-screen ${theme === 'dark' ? 'bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900' : 'bg-gray-50'}`}
    >
      ...
      {theme === 'dark' && (
        <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
          ...
          <div
            className="absolute bottom-20 right-10 w-96 h-96 bg-primary-500/15 rounded-full blur-3xl animate-pulse"
