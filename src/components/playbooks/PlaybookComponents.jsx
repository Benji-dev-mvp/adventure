      ...
      steps: [
        {
          ...
          title: 'Build Rapport',
          duration: '5 min',
          talking_points: ['Personal connection', 'Company background'],
        },
        {
          step: 2,
          title: 'Understand Pain Points',
          duration: '10 min',
          talking_points: ['Current process', 'Challenges', 'Impact'],
        },
        {
          step: 3,
          title: 'Present Solution',
          duration: '15 min',
          talking_points: ['Feature match', 'ROI discussion'],
        },
        {
          step: 4,
          title: 'Next Steps',
          duration: '5 min',
          talking_points: ['Timeline', 'Decision makers', 'Follow-up'],
        },
      ],
    },
    {
      ...
      steps: [
        {
          ...
          duration: '3 min',
          talking_points: ['Objectives', 'Time allocation'],
        },
        {
          step: 2,
          title: 'Feature Walkthrough',
          duration: '20 min',
          talking_points: ['Key features', 'Use cases', 'Q&A'],
        },
        {
          step: 3,
          title: 'ROI Discussion',
          duration: '10 min',
          talking_points: ['Value proposition', 'Cost savings'],
        },
        {
          step: 4,
          title: 'Close',
          duration: '7 min',
          talking_points: ['Trial offer', 'Next meeting'],
        },
      ],
    },
    {
      ...
      steps: [
        {
          ...
          title: 'Anchor High',
          duration: '5 min',
          talking_points: ['Full price value', 'Premium features'],
        },
        {
          step: 2,
          title: 'Handle Objections',
          duration: '15 min',
          talking_points: ['Budget concerns', 'Competitor comparison'],
        },
        {
          step: 3,
          title: 'Offer Concessions',
          duration: '10 min',
          talking_points: ['Volume discounts', 'Payment terms'],
        },
        {
          step: 4,
          title: 'Close Deal',
          duration: '10 min',
          talking_points: ['Sign contract', 'Kick-off date'],
        },
      ],
    },
  ]);
    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Step-by-step guides for every deal stage
        </p>
      </CardHeader>
      <CardContent>
        {!selectedPlaybook ? (
                ...
                >
                  ...
                  <ul className="text-sm space-y-1">
                    {step.talking_points.map((point, idx) => (
                      <li
                        key={`talking-point-${idx}-${point.substring(0, 10)}`}
              ...
              <div className="p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg">
                ...
                <ol className="space-y-2">
                  {selectedCompetitor.how_to_win.map((tactic, idx) => (
                    <li
                      key={`tactic-${idx}-${tactic.substring(0, 10)}`}
      ...
      responses: [
        {
          approach: 'ROI Focus',
          response:
            'I understand budget is important. Our customers typically see 10x ROI in the first quarter. Let me show you how Ava replaces 5 SDRs at 1/10th the cost.',
        },
        {
          approach: 'Value Comparison',
          response:
            'Compared to hiring an SDR ($60K salary + benefits), Ava costs less than $10K/year and works 24/7 without vacation.',
        },
        {
          approach: 'Cost of Inaction',
          response:
            "What's the cost of your sales team spending 80% of their time on manual outreach instead of closing deals?",
        },
      ],
    },
    {
      ...
      responses: [
        {
          approach: 'Add-On Value',
          response:
            'Great! Many customers use us alongside [competitor]. Ava handles the entire top-of-funnel while your team focuses on closing. Would you like to see a side-by-side comparison?',
        },
        {
          approach: 'Pain Point',
          response:
            "What made you choose them initially? Are there any areas where they're falling short? I'd love to show you how Ava specifically addresses those gaps.",
        },
        {
          approach: 'Migration Ease',
          response:
            'We make migration seamless - most customers are up and running in 2 days with better results than their previous tool.',
        },
      ],
    },
    {
      ...
      responses: [
        {
          approach: 'Uncover Real Objection',
          response:
            'Absolutely, this is an important decision. To help you think through it, what specific areas do you need more clarity on?',
        },
        {
          approach: 'Create Urgency',
          response:
            "I completely understand. Just so you know, we have 50 spots left for our onboarding this quarter. After that, there's a 6-week waitlist. When were you hoping to see results?",
        },
        {
          approach: 'Next Steps',
          response:
            "Makes sense. How about we schedule a quick 15-min call next week after you've had time to discuss internally? I can answer any questions that come up.",
        },
      ],
    },
    {
      ...
      responses: [
        {
          approach: 'Show Results',
          response:
            "I hear you - skepticism about AI is valid. That's why we offer a 2-week trial. Our customers see 31% response rates vs 8% industry average. Ava handles research and personalization; humans close deals.",
        },
        {
          approach: 'Hybrid Approach',
          response:
            "You're right - AI shouldn't replace humans entirely. Ava handles the repetitive 80% (research, email writing, follow-ups) so your team focuses on the high-value 20% (calls, demos, closing).",
        },
        {
          approach: 'Social Proof',
          response:
            "I understand the concern. That's what [Customer Name] said before trying Ava. Now they've 3x'd their pipeline with the same team size. Want to see their case study?",
        },
      ],
    },
  ]);
      ...
      <CardContent>
        <div className="space-y-3">
          {objections.map((obj, idx) => (
            <div
              key={`objection-${idx}-${obj.objection?.substring(0, 10)}`}
...
export const ROICalculator = () => {
  ...
  const calculations = {
    ...
    roi: Math.round(
      ((inputs.sdrs * inputs.sdrSalary - inputs.artisanCost) / inputs.artisanCost) * 100
    ),
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Show prospects their ROI in real-time
        </p>
      </CardHeader>
      <CardContent>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setInputs({ ...inputs, responseRateIncrease: parseInt(e.target.value) })
                }
              />
            </div>
          </div>
