  ...
  const stages = [
    {
      ...
      phase: "Integration",
      description: "Connect Salesforce, LinkedIn Sales Nav, ZoomInfo, and 8+ tools into one platform",
      dataPoints: [
    ...
    },
    {
      ...
      phase: "Optimization",
      description: "Analyze your #1 rep's emails, extract patterns, create playbook for entire team",
      dataPoints: [
    ...
    },
    {
      ...
      phase: "Compliance",
      description: "Auto-check every message for compliance, send high-value accounts through approval",
      dataPoints: [
        "DLP Scan: 100% passed",
    ...
    },
    {
      ...
      phase: "Execution",
      description: "Send across multiple domains with smart timing based on timezone and engagement data",
      dataPoints: [
        "Domains: 5 active",
        "Sending: Timezone optimized",
        "Daily Volume: 2,000/day"
      ],
    ...
    },
    {
      ...
      phase: "Optimization",
      description: "Ava analyzes what works, automatically improves campaigns, shares insights across team",
      dataPoints: [
        "A/B Tests: 23 running",
        "Winners: Auto-scaled",
        "Team Learning: Shared"
      ],
            ...
            <div className="bg-gradient-to-br from-blue-900/30 to-cyan-900/30 border-2 border-blue-500/30 rounded-xl p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between pb-2 border-b border-blue-500/30">
                  ...
                  <span className="text-white"><span className="line-through text-red-400">12</span> → <span className="text-green-400">1</span></span>
                </div>
                <div className="flex justify-between pb-2 border-b border-blue-500/30">
                  <span className="text-gray-400">Monthly Software Cost:</span>
                  <span className="text-white"><span className="line-through text-red-400">$4,800</span> → <span className="text-green-400">$1,600</span></span>
                </div>
                <div className="flex justify-between pb-2 border-b border-blue-500/30">
                  <span className="text-gray-400">Meetings per Rep/mo:</span>
                  <span className="text-white"><span className="line-through text-red-400">8</span> → <span className="text-green-400">23</span></span>
                </div>
                <div className="flex justify-between pt-2">
                  <span className="text-gray-400">Context Switches:</span>
                  <span className="text-white"><span className="line-through text-red-400">47/day</span> → <span className="text-green-400">0</span></span>
                </div>
              </div>
            </div>
          </div>
