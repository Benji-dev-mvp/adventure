...
export const marketingContent = {
  hero: {
    ...
    subhead: "Transform your B2B outbound with intelligent multi-channel campaigns that scale. From prospecting to close, Artisan orchestrates every touchpoint.",
    cta: {
    ...
    steps: [
      {
        ...
        description: "Import, enrich, and score leads with AI-powered data intelligence. Our system automatically identifies your best-fit accounts.",
      ...
      },
      {
        ...
        description: "Design multi-channel campaigns that adapt to prospect behavior. Email, LinkedIn, calls, and SMS—orchestrated in perfect rhythm.",
      ...
      },
      {
        ...
        description: "Ava, your AI assistant, handles outreach with personalization at scale. Every message feels 1:1, but reaches thousands.",
        visual: "ai-assistant",
      ...
      },
      {
        ...
        description: "Real-time analytics surface what's working. AI recommendations guide your next move. Continuous improvement, zero guesswork.",
        visual: "analytics",
      ...
      },
      {
        ...
        description: "Focus on high-intent prospects while Artisan nurtures the rest. Your pipeline stays full, your calendar stays focused.",
        visual: "dashboard",
    ...
    grid: [
      {
        ...
        expanded: {
          description: "Build campaigns that reach prospects where they are. Smart delays and behavior-based triggers ensure every touchpoint lands at the right moment.",
          capabilities: ["Email sequences", "LinkedIn automation", "SMS cadences", "Call scripts & tracking"],
      ...
      },
      {
        ...
        expanded: {
          description: "Ava learns your voice, understands your ICP, and crafts personalized messages at scale. Professional, casual, or enthusiastic—she adapts to your brand.",
          capabilities: ["Message generation", "Personalization", "Tone control", "Auto-optimization"],
      ...
      },
      {
        ...
        expanded: {
          description: "No more hunting for emails or checking LinkedIn profiles. Our enrichment engine fills in missing data, validates contacts, and scores every lead.",
          capabilities: ["Email finding", "Company intelligence", "Technology stack", "Funding & signals"],
      ...
      },
      {
        ...
        expanded: {
          description: "Dashboards that tell stories. Track opens, clicks, replies, and conversions across every channel. AI-powered recommendations guide optimization.",
          capabilities: ["Campaign performance", "A/B test results", "Conversion funnels", "Predictive insights"],
      ...
      },
      {
        ...
        expanded: {
          description: "Policy-driven sending with human-in-the-loop safeguards. DLP, PII scrubbing, and audit logs for every action. Governance without friction.",
          capabilities: ["Approval workflows", "DLP & PII detection", "Audit trails", "Role-based access"],
      ...
      },
      {
        ...
        expanded: {
          description: "Two-way sync with Salesforce, HubSpot, Outlook, and more. Leads, activities, and outcomes update in real-time across your stack.",
  ...
  aiAgent: {
    title: "Meet Ava",
    subtitle: "Your AI sales assistant that never sleeps, never misses a follow-up, and gets better every day",
    persona: {
      name: "Ava",
    ...
    capabilities: [
      {
        ...
        description: "Ava analyzes your top-performing messages and adapts her style to match. Every email feels personal, never robotic.",
        metric: "92% approval rate from human reviewers"
      },
      {
        title: "Learns From Every Interaction",
        description: "Ava tracks which subject lines, CTAs, and personalizations drive replies. She continuously optimizes your campaigns.",
        metric: "18% average lift in response rates over 30 days"
      },
      {
        title: "Handles Multi-Channel Coordination",
        description: "Email didn't get a reply? Ava follows up on LinkedIn. Still no response? She schedules a call attempt. All automatically.",
        metric: "3.5x more touchpoints without adding headcount"
      },
      {
        title: "Respects Boundaries",
        description: "Ava never sends on weekends (unless you tell her to), pauses campaigns when prospects reply, and adheres to unsubscribe requests instantly.",
        metric: "< 0.1% spam complaint rate"
      }
    ],
    interactive: {
      title: "See Ava in action",
      prompt: "Write a follow-up email for a SaaS founder who viewed our pricing page but didn't book a demo",
...
{{senderName}}`
  ...
  testimonials: {
    ...
    quotes: [
      {
        id: 1,
        quote: "Artisan turned our outbound from a necessary evil into our #1 revenue channel. We're booking 3x more meetings with the same team size.",
        author: "Sarah Chen",
        role: "VP Sales",
        company: "Vertex AI",
      ...
      {
        id: 2,
        quote: "The AI assistant actually writes better emails than most of our reps. And it never takes a vacation.",
      ...
      {
        id: 3,
        quote: "We replaced 4 tools with Artisan and increased our pipeline by 40%. The ROI was obvious in month one.",
        author: "Emily Park",
        role: "CRO",
        company: "CloudScale",
      ...
      {
        id: 4,
        quote: "Finally, a platform that understands enterprise compliance. SOC 2, approval workflows, and DLP out of the box.",
  ...
  finalCTA: {
    ...
    subhead: "Join thousands of revenue teams who've replaced complexity with results. Free 14-day trial. No credit card required.",
    cta: {
      primary: "Start Free Trial",
