      ...
      scopes.forEach(scope => {
        ...
        capabilities.forEach(cap => {
          if (targetRole.permissions.includes('*')) {
            ...
            matrix[scope.id][cap] =
              targetRole.permissions.includes(fullPerm) ||
...
export function useSecurityStatus() {
  ...
  const issues = useMemo(() => {
    ...
    if (status.mfa.adoptionPercent < 80)
      list.push({ type: 'warning', message: `MFA adoption at ${status.mfa.adoptionPercent}%` });
    ...
    () => [
        ...
        items: [
          {
            ...
            done: security.sso.enabled,
            link: '/settings/security',
          },
          {
            key: 'mfa',
            label: 'MFA Enforced',
            done: security.mfa.enabled && security.mfa.adoptionPercent >= 80,
            link: '/settings/security',
          },
          {
            key: 'scim',
            label: 'SCIM Provisioning',
            done: security.scim.enabled,
            link: '/settings/security',
          },
      ...
      },
      {
        ...
        items: [
          {
            key: 'residency',
            label: 'Data Residency Set',
            done: security.dataResidency.compliant,
      ...
      },
      {
        ...
        items: [
          {
            key: 'policies',
            label: 'AI Policies Defined',
            done: false,
            link: '/settings/ai-policies',
          },
          {
            key: 'decisions',
          ...
          {
            key: 'killswitch',
            label: 'Kill Switches Ready',
            done: flagList.some(f => f.isKillSwitch),
