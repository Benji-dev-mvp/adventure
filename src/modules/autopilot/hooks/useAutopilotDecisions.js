...
const MOCK_DECISIONS = [
  {
    ...
    description:
      'Narrowed midmarket ICP to focus on companies with recent funding rounds. Analysis showed 2.3x higher reply rates from recently funded prospects.',
  ...
  },
  {
    ...
    description:
      'ML model recommended adding a 4th email touchpoint with case study. Historical data shows 18% incremental meetings from extended sequences.',
  ...
  },
  {
    ...
    description:
      'Detected bounce rate spike to 4.2%. Automatically reduced daily send volume by 40% and switched to warm-up mode for affected domains.',
  ...
  },
  {
    ...
    description:
      'Increased LinkedIn allocation for EU midmarket segment. Data shows 35% higher engagement from LinkedIn vs email in EMEA region.',
  ...
  },
  {
    ...
    description:
      'Reply rates dropped 22% week-over-week. System ramped email cadence frequency and introduced new subject line variants.',
  ...
  },
  {
    ...
    description:
      'Updated lead scoring model with new intent signals from G2 and TrustRadius. VP-level contacts now weighted 1.4x higher.',
  ...
  },
  {
    ...
    description:
      'Automatically paused Healthcare program for holiday period. Will resume January 2nd with refreshed messaging.',
