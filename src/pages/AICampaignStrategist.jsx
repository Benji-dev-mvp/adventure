...
import { Sparkles, Target, TrendingUp, Calendar, DollarSign, Users, Mail, Linkedin, Phone, Zap, CheckCircle2, ArrowRight, Loader2, BarChart3 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Data-driven campaign planning with predictive ROI and tactical recommendations</p>
          </div>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-600 mt-1">
                  Our AI analyzes your past campaigns (Mem0), reviews historical performance data (LlamaIndex), 
                  generates a type-safe strategy (Pydantic AI), and provides tactical recommendations (LangChain).
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-xs text-gray-500">Processing campaign patterns and industry benchmarks</p>
            </div>
          ) : strategy ? (
            <div className="space-y-6">
              {/* Key Metrics */}
              <div className="grid grid-cols-3 gap-3">
                <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200">
                  ...
                  <div className="text-2xl font-bold text-green-700">{strategy.strategy.estimated_roi.toFixed(1)}%</div>
                  <div className="text-xs text-gray-600 mt-1">Estimated ROI</div>
                </div>

                <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                  <Calendar className="w-6 h-6 text-blue-600 mx-auto mb-2" />
                  <div className="text-2xl font-bold text-blue-700">{strategy.strategy.timeline_days}</div>
              ...
              <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-600 mt-1">Multi-touch engagement strategy</div>
                  </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="p-3 bg-purple-50 rounded-lg text-center border border-purple-200">
                  <div className="text-2xl font-bold text-purple-600">{strategy.past_learnings_incorporated}</div>
                  <div className="text-xs text-gray-600 mt-1">Past Learnings</div>
                </div>
                <div className="p-3 bg-green-50 rounded-lg text-center border border-green-200">
                  <div className="text-2xl font-bold text-green-600">{strategy.historical_data_analyzed}</div>
        ...
        <div className="max-w-7xl mx-auto mt-6">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
            ...
            <div className="relative">
              ...
              {Array.from({length: strategy.strategy.sequence_steps}, (_, i) => i + 1).map((step) => (
                  ...
                  <div className="flex-1 pt-2">
                    <div className="font-medium text-gray-900">
                      {step === 1 ? 'Initial Outreach' :
                       ...
                       step === 3 ? 'Social Proof' :
                       step === 4 ? 'Problem Focus' :
                       step === 5 ? 'Solution Demo' :
                       step === 6 ? 'Pricing Discussion' :
                       step === 7 ? 'Final Call-to-Action' :
                       `Touch Point ${step}`}
                    </div>
                    <div className="text-sm text-gray-600 mt-1">
                      Day {Math.round((strategy.strategy.timeline_days / strategy.strategy.sequence_steps) * step)}
                    </div>
                  </div>
                </div>
              ))}
