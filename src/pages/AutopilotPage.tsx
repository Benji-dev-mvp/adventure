...
const AutopilotDashboard = lazy(() =>
  import('@/modules/autonomy/AutopilotDashboard').then(m => ({ default: m.AutopilotDashboard }))
);
...
const ActivityTicker = () => {
  const activities = useMemo(
    () => [
      {
        icon: Brain,
        text: 'AI adjusted send timing for enterprise segment',
        time: '2m ago',
        type: 'ai',
      },
      {
        icon: Zap,
        text: 'New A/B test launched: Subject line variant',
        time: '8m ago',
        type: 'experiment',
      },
      {
        icon: RefreshCw,
        text: 'Model retrained with latest conversion data',
        time: '15m ago',
        type: 'model',
      },
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                AI-driven GTM operations • Real-time optimization
              </p>
            </div>
          </div>
