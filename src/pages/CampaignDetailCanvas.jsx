  ...
  return (
    <DashboardLayout>
      <div className="flex h-[calc(100vh-64px)]">
        ...
        <div className="w-72 border-r border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900/50 p-6 overflow-y-auto shrink-0">
          <button
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-gray-50 dark:bg-white/5 rounded-lg p-3">
                <p className="text-2xl font-bold text-green-500">{campaign.stats.meetings}</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Meetings</p>
              </div>
              <div className="bg-gray-50 dark:bg-white/5 rounded-lg p-3">
                <p className="text-2xl font-bold text-blue-500">{campaign.stats.openRate}%</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Open Rate</p>
              </div>
              <div className="bg-gray-50 dark:bg-white/5 rounded-lg p-3">
                <p className="text-2xl font-bold text-purple-500">{campaign.stats.replyRate}%</p>
        ...
        <div className="w-80 border-l border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900/50 p-6 overflow-y-auto shrink-0">
