...
const Dashboard = () => {
  ...
  return (
    ...
    >
      ...
      {/* AI Intelligence - Enterprise Features */}
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Advanced AI capabilities powered by LangChain, Mem0, LlamaIndex & Pydantic AI</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Lead Intelligence */}
          <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-2 border-transparent hover:border-purple-500/50 cursor-pointer" onClick={() => navigate('/ai-lead-intelligence')}>
            <CardContent className="p-6">
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg">
                  <Target className="text-white" size={28} />
                </div>
                <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">Lead Intelligence</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Context-aware lead scoring with memory & RAG</p>
                <div className="flex flex-wrap gap-1 justify-center mb-4">
                  <Badge variant="outline" className="text-xs">Mem0</Badge>
          ...
          {/* Email Generation */}
          <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-2 border-transparent hover:border-blue-500/50 cursor-pointer" onClick={() => navigate('/ai-email-generator')}>
            <CardContent className="p-6">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">Smart Email Gen</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Personalized emails using past interactions</p>
                <div className="flex flex-wrap gap-1 justify-center mb-4">
                  <Badge variant="outline" className="text-xs">Pydantic AI</Badge>
          ...
          {/* Campaign Strategy */}
          <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-2 border-transparent hover:border-emerald-500/50 cursor-pointer" onClick={() => navigate('/ai-campaign-strategy')}>
            <CardContent className="p-6">
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg">
                  <Activity className="text-white" size={28} />
                </div>
                <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">Campaign Strategy</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Data-driven strategies with learnings</p>
                <div className="flex flex-wrap gap-1 justify-center mb-4">
                  <Badge variant="outline" className="text-xs">LangChain</Badge>
                  <Badge variant="outline" className="text-xs">Historical</Badge>
                  <Badge variant="outline" className="text-xs">AI Recs</Badge>
                </div>
                <Button size="sm" className="w-full gap-2">
                  <BarChart3 size={14} />
                  Plan Campaign
          ...
          {/* AI Assistant */}
          <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-2 border-transparent hover:border-amber-500/50 cursor-pointer" onClick={() => navigate('/ai-assistant-advanced')}>
            <CardContent className="p-6">
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg">
                  <Brain className="text-white" size={28} />
                </div>
                <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">AI Assistant Pro</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Full context awareness & tool execution</p>
                <div className="flex flex-wrap gap-1 justify-center mb-4">
                  <Badge variant="outline" className="text-xs">All Frameworks</Badge>
        ...
        <Card className="mt-4 bg-gradient-to-r from-purple-50 via-blue-50 to-emerald-50 dark:from-purple-900/20 dark:via-blue-900/20 dark:to-emerald-900/20 border-2 border-purple-200 dark:border-purple-500/30">
          <CardContent className="p-4">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-2">
                <Gauge className="text-purple-600" size={20} />
                <span className="font-semibold text-sm text-gray-900 dark:text-white">AI Systems Status</span>
              </div>
              <div className="flex items-center gap-6 flex-wrap">
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                  <span className="text-xs text-gray-600 dark:text-gray-400">LangChain</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                  <span className="text-xs text-gray-600 dark:text-gray-400">Pydantic AI</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                  <span className="text-xs text-gray-600 dark:text-gray-400">Mem0 Memory</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                  <span className="text-xs text-gray-600 dark:text-gray-400">LlamaIndex RAG</span>
                </div>
                <Button variant="ghost" size="sm" className="text-xs" onClick={() => navigate('/ai-assistant-advanced')}>
                  View Details →
                </Button>
              </div>
            </div>
