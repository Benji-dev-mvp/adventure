      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">
            Welcome! Let's set up your AI BDR
          </h1>
          <p className="text-white/90">
            Just a few quick steps to get Ava working for you
          </p>
        </div>
          ...
          <div className="flex items-center justify-between mb-2">
            {[...Array(totalSteps)].map((_, index) => (
              <div key={index} className="flex-1 flex items-center">
                ...
                {index < totalSteps - 1 && (
                  <div className={`flex-1 h-1 mx-2 ${step > index + 1 ? 'bg-white' : 'bg-white/20'}`} />
                )}
              </div>
            ))}
          </div>
                  ...
                  {[
                    ...
                    return (
                      ...
                      >
                        ...
                        {isSelected && (
                          <p className="text-xs text-accent-600 mt-2">Selected</p>
                        )}
                      </button>
                    );
                  })}
            ...
            {step === 2 && (
              <div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48'%3E%3Cpath fill='%23EA4335' d='M24 9.5c3.9 0 6.7 1.7 8.2 3.1l6.1-5.9C34.9 3.5 29.9 1 24 1 14.8 1 7.1 6.7 4.2 14.7l7.1 5.5C13 14.6 18 9.5 24 9.5z'/%3E%3Cpath fill='%2334A853' d='M46.5 24.5c0-1.6-.1-3.1-.4-4.5H24v9h12.7c-.6 3-2.3 5.5-4.8 7.2l7.4 5.7c4.3-4 6.7-9.9 6.7-17.4z'/%3E%3Cpath fill='%234A90E2' d='M11.3 28.2c-.6-1.7-.9-3.5-.9-5.2s.3-3.5.9-5.2l-7.1-5.5C2.7 15.7 1.5 19.7 1.5 24s1.2 8.3 3.7 11.7l7.1-5.5z'/%3E%3Cpath fill='%23FBBC05' d='M24 47c5.9 0 10.9-1.9 14.5-5.2l-7.4-5.7c-2 1.3-4.5 2.1-7.1 2.1-6 0-11-4.1-12.7-9.6l-7.1 5.5C7.1 41.3 14.8 47 24 47z'/%3E%3C/svg%3E" alt="Gmail" className="w-6 h-6" />
                    {isConnecting && emailProvider !== 'Gmail' ? 'Connecting...' : emailProvider === 'Gmail' ? 'Gmail Connected' : 'Connect Gmail'}
                  </Button>
                  ...
                  <Button
                    ...
                    disabled={isConnecting}
                  >
                    <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48'%3E%3Cpath fill='%230078D4' d='M44 24c0 11-9 20-20 20S4 35 4 24 13 4 24 4s20 9 20 20z'/%3E%3Cpath fill='%23FFF' d='M21 15h14v4H21v-4zm0 6h14v4H21v-4zm0 6h10v4H21v-4z'/%3E%3C/svg%3E" alt="Outlook" className="w-6 h-6" />
                    {isConnecting && emailProvider !== 'Outlook' ? 'Connecting...' : emailProvider === 'Outlook' ? 'Outlook Connected' : 'Connect Outlook'}
                  </Button>
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div className={`w-12 h-12 ${crm.color} rounded-xl flex items-center justify-center text-2xl`}>
                          {crm.logo}
                        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-gradient-to-br from-accent-50 to-primary-50 rounded-xl">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900 mb-1">Ava will personalize this for you!</p>
                        <p className="text-sm text-gray-600">
                          Based on your ICP, Ava will research leads, write personalized emails, and optimize send times automatically.
                        </p>
                      </div>
                    </div>
                  </div>
